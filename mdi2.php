                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-7">
                                            ...
                                            <a type="button" id="btn-mb" class="btn btn-success" href="#"><i
                                        ...
                                        <div class="col-5 justify-content-end " style="transform: translateX(8rem);">
                                            <form class="form-inline" name="form-SMB">
                                                <div class="form-group">
                                                    <label for=""></label>
                                                    <input type="text" name="s_mb" id="" class="form-control"
                                                        placeholder="" aria-describedby="helpId">
                                                </div>
                                                <button type="submit" class="btn btn-primary"
                                                    onclick="searchMember(event)">Tìm kiếm</button>
                                            </form>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-bordered">
                                            <thead style="background-color: black; color:white; text-align:center">
                                                <tr>
                                                    ...
                                                    <th>Ngày gởi Feedback</th>
                                                    <th>Ngày trả lời Feedback</th>                                                    
                                                    <th>Lựa chọn</th>
                                                </tr>
                                            </thead>
                                            <tbody id="t_mb">
                        ...
                        foreach ($class as $item) { ?>
                                                <tr class='table-info' style="text-align: center;">
                                                    ...
                                                    <td><a type='button' class='btn btn-info'
                                                            href='feedbackAD.php?id_lp=<?= $item['feedback_id'] ?>'><i
                                                                class='fas fa-user-edit'></i></a> <a type='button'
                                                            class='btn btn-danger'
                                                            href='xoaFB.php?id_lp=<?= $item['feedback_id'] ?>'><i
