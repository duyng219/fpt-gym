...
$sql = "SELECT * FROM feedback where member_id = '$id';";
            ...
            <div class="modal-content">
                ...
                <form class="membership-form webform" name="form-feedback" role="form" action="feedback.php"
                    ...
                    <table>
                        ...
                        <p></p>
                        <h3>Nội dung đã phản hồi</h3>
                        <br>
                        <tr><b>Nội dung bạn gởi:</b> 
                        ...
                        name="feedback" style="background-color:coral;">Gởi thông tin</button>                        
                        </table>
                    </form>
                </div>
