...
<body>
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    <div class="form-group row">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Khóa Học</label>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input name="GiaGoi" type="text" class="form-control" id="exampleInputConfirmPassword2" placeholder="VND">
                      </div>
                    </div>
                    <button name="accept" type="submit" class="btn btn-primary mr-2">Xác Nhận</button>
                  ...
                  <?php
                      ...
                      $Goi = $_POST['goitap'];
                      $Gia = $_POST['GiaGoi'];
                      $query = "update gt set GiaGoi = '$Gia' where tenGT = '$Goi'";
                      $rs = mysqli_query($conn,$query);
                      mysqli_query($conn,$query) or die*("Error");
                      echo  "<br> <span style ='color : #227093'><i class='fas fa-check-circle'></i></span> <b> Chỉnh Sửa Thành Công</b>" ;
                      }
                  ?>
  ...
  <script src="../../jsPT/file-upload.js"></script>
  <script src="../../jsPT/typeahead.js"></script>
  <script src="../../jsPT/select2.js"></script>
