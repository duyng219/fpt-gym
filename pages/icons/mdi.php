...
$sql_class = "SELECT class_id, trainer_id, trainer_name, class_name, room, date_of_week, 
              start_time, end_time, start_date, end_date FROM class";
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#icons" aria-expanded="false" aria-controls="icons">
                            <i class="fas fa-envelope"></i>&emsp;
                            <span class="menu-title">Quản Feedback</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="icons">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-7">
                                            ...
                                            <a type="button" id="btn-mb" class="btn btn-success" href="themlop.php"><i class="fas fa-user-plus"></i></a>
                                        </div>
                                    ...
                                    <div class="table-responsive pt-3" style="width: 92rem;">
                                        <table class="table table-bordered">
                                            <thead style="background-color: black; color:white; text-align:center">
                                                <tr>
                                                    ...
                                                    <th>Phòng tập</th>
                                                    <th>Ngày tập trong tuần</th>
                                                    <th>Giờ bắt đầu tập</th>
                                                    <th>Ngày bắt đầu lớp</th>
                                            ...
                                            <tbody id="t_mb">
                                                ...
                                                foreach ($class as $item) { ?>
                                                    <tr class='table-info'>
                                                        ...
                                                        <td><?= $item['end_date'] ?></td>
                                                        <td><a type='button' class='btn btn-info' href='sualop.php?id_lp=<?= $item['class_id'] ?>'><i class='fas fa-user-edit'></i></a> <a type='button' class='btn btn-danger' href='xoalop.php?id_lp=<?= $item['class_id'] ?>'><i class='fas fa-user-times'></i></a></td>
                                                    </tr>
                                                <?php $stt++;
                                                } ?>
                                            </tbody>
