    ...
    <div class="container">
        <div class="main-body">
            ...
            <nav aria-label="breadcrumb" class="main-breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="trainer.php">Trang chính</a></li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="membership-form webform" role="form" action="edit.php" method="POST">
                        ...
                        <input type="text" class="form-control mt-1" name="cf-name" placeholder="Họ và Tên" value="<?= $name ?>">
                        ...
                        <input type="tel" class="form-control mt-1" name="cf-phone" placeholder="Nhập số điện thoại 123-456-7890" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" value="<?= $phone ?>">

                        <input type="text" class="form-control mt-1" name="cf-age" placeholder="Nhập tuổi" value="<?= $age ?>">
                        ...
                        <button type="submit" class=" form-control mt-1" id="submit-button" name="trainer-edit" style="font-weight: bold; background-color:cyan">Cập nhật</button>
                ...
                <div class="modal-body">
                    <form class="membership-form webform" name="formChangePass" role="form" action="changePassword.php" method="POST">
                        ...
                        <div class="form-group">
                            <label for=""></label>
                            <input type="password" class="form-control" name="new-password" placeholder="Mật khẩu mới" required>
                        ...
                        <button type="submit" class="form-control mt-1" id="submit-button" name="submit-trainer" style="font-weight: bold; background-color:cyan">Đổi mật khẩu</button>
                    </form>
                </div>
